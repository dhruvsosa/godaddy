                    ...
                    <div className="tw-container tw-px-5 tw-py-24 tw-mx-auto tw-flex tw-flex-wrap Tablate">
                        <div className="lg:tw-w-2/3 tw-mx-auto">
                            <div className="tw-flex tw-flex-wrap tw-w-full tw-py-32 tw-px-10 tw-relative tw-mb-4 Tablate-div">
                                <img alt="gallery" className="tw-w-full tw-object-cover tw-h-full tw-object-center tw-block tw-absolute tw-inset-0 tw-rounded-3xl" src="https://img1.wsimg.com/cdnassets/transform/3343fa4c-902b-4658-9299-dce12e1467e6/intl-img-hp-recore-domains-large-portrait" />
                            ...
                            <div className="tw-flex tw-flex-wrap -tw-mx-2">
                                <div className="tw-px-2 tw-w-1/2" id="hidden1">
                                    <div className="tw-flex tw-flex-wrap tw-w-full sm:tw-py-24 tw-py-16 sm:tw-px-10 tw-px-6 tw-relative">
                                        <img alt="gallery" className="tw-w-full tw-object-cover tw-h-full tw-object-center tw-block tw-rounded-3xl tw-absolute tw-inset-0" src="https://img1.wsimg.com/cdnassets/transform/fa9063d0-1ec3-4ab1-83e8-dbf6d03f9d3c/img-hp-recore-co-small" />
                                ...
                                <div className="tw-px-2 tw-w-1/2" id='hidden'>
                                    <div className="tw-flex tw-flex-wrap tw-w-full sm:tw-py-24 tw-py-16 sm:tw-px-10 tw-px-6 tw-relative">
                                        <img alt="gallery" className="tw-w-full tw-object-cover tw-h-full tw-object-center tw-block tw-rounded-3xl tw-absolute tw-inset-0" src="https://img1.wsimg.com/cdnassets/transform/ab758ae9-0592-4e88-8623-409257c378fc/intl-img-hp-recore-cctld-small" />
                                        <div className="tw-relative tw-top-16 -tw-left-4">
